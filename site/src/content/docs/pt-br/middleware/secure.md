---
title: Secure
description: Proteja contra XSS, content sniffing, clickjacking e outros ataques de injeção.
sidebar:
  order: 22
---
...
:::note
Passar `XSSProtection`, `ContentTypeNosniff`, `XFrameOptions` ou
`ContentSecurityPolicy` vazios desabilita essa proteção.
:::
