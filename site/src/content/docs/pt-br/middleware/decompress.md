---
title: Decompress
description: Descomprima transparentemente bodies de request codificados com gzip.
sidebar:
  order: 8
---
...
:::note
O body é descomprimido em memória e mantido ali durante toda a vida do request (e
